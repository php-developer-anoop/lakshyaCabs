    ...
    <div class="wd_dashcontent">
      <div class="container myprofilepage">
        <div class="row">
          ...
          <?=form_open_multipart(base_url('save-profile'))?>
          <?=form_hidden('id',$id)?>
         ...
         <div class="row profile_form mb-5">
            ...
            <div class="uplodpic">
              <div class="imgprw">
                <img src="<?=base_url('assets/frontend/')?>images/camera.svg">
              </div>
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="mb-3 position-relative">
                  ...
                  <input placeholder="Enter your mobile number" autocomplete="off" type="text" id="mobile_no" required name="mobile_no" maxlength="10" class="form-control notzero numbersWithZeroOnlyInput" value="<?=$mobile_no?>">
                </div>
              </div>
              <div class="col-6">
                <div class="mb-3">
            ...
            <div class="row">
              ...
              <div class="col-6">
                <div class="mb-3">
                  ...
                  <input placeholder="Enter pan number" autocomplete="off" name="company_pan_number" type="text" id="company_pan_number" class="form-control" value="<?=$company_pan_number?>">
                </div>
              </div>
              <div class="col-6">
                <div class="mb-3">
                  <label class="form-label" for="gstin_number">GSTIN</label>
                  <input placeholder="Enter GST number" autocomplete="off" name="gstin_number" type="text" id="gstin_number" class="form-control" value="<?=$gstin_number?>">
                </div>
              </div>
              <div class="col-6">
                <div class="mb-3">
                  <label class="form-label" for="company_state">Company State</label>
                  <select name="company_state" id="company_state" class="form-control select2" required onchange="getCompanyCities(this.value,'<?=$company_city?>')">
                    <option value="">--Select State--</option>
                  <?php if(!empty($states)){foreach($states as $key=>$value){?>
                    <option value="<?=$value['id'].','.$value['state_name']?>" <?=!empty($company_state) && ($company_state==$value['id'])?"selected":""?>><?=$value['state_name']?></option>
                    <?php }} ?>
                  </select>
                </div>
              </div>
              <div class="col-6">
                <div class="mb-3">
                  ...
                  <select name="company_city" id="company_city" class="form-control select2" required>
                    <option value="">--Select City--</option>
                  </select>
                </div>
              </div>
              ...
              <div class="col-6">
                <div class="mb-3">
                  <label class="form-label" for="exampleForm.ControlTextarea1">Company Address</label>
                  <textarea placeholder="Enter Company Address" autocomplete="off" name="company_address" rows="5" id="exampleForm.ControlTextarea1" class="form-control"><?=$company_address?></textarea>
                </div>
              </div>
            </div>
