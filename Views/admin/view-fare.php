    ...
    <div class="card pt-2">
        <div class="card-body">
          <div class="dflexbtwn hdngvwall">
              ...
              <a href="<?= base_url(ADMINPATH . 'add-fare') ?>" class="sitebtn">Add</a>
          </div>
    ...
    function loadAllRecordsData(qparam) {
       // alert(qparam);
        ...
        $('#responseData').DataTable({
            ...
            { data: "id", "title": "Fare Details", "render": fare_details },
            { data: "id", "title": "Charges", "render": charges },
            { data: "id", "title": "Vehicle","name":"Vehicle", "render": vehicleDetails },
            { data: "id", "title": "Pickup/Drop", "render": location_details },
...
function action_render(data, type, row, meta) {
  ...
  if (type === 'display') {
    ...
    output = '<a href="<?= base_url(ADMINPATH . "add-fare?id=") ?>' + row.id + '&trip_type='+row.trip_type+'" class="btn actnbtn btn-orange" title="Edit Fare"><i class="tf-icons bx bx-edit"></i></a> ';
