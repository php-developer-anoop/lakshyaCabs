      ...
      <div class="col-xxl">
        <div class="card mb-4">
          <div class="card-body">
            ...
            <?=form_open_multipart(ADMINPATH . 'save-city-seo-page'); ?>
            <?=form_hidden('id',$id)?>
            ...
            <div class="row mb-3">
              <div class="col-sm-6">
                ...
                <input type="text" name="page_name" autocomplete="off"  value="<?=$page_name?>" onkeyup="return checkDuplicate(this.value,'all_cms_data','page_name')"  class="form-control ucwords restrictedInput" required id="page_name" placeholder="Page Name" />
              </div>
              <div class="col-sm-6">
