<div class="content-wrapper">
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="dflexbtwn hdngvwall">
                ...
                <a href="<?= base_url(ADMINPATH . 'raised-ticket-list') ?>" class="sitebtn">View List</a>
          </div>
    <div class="row gy-3">
      <div class="col-lg-3">
        <div class="card sideticket border-0 rounded-3">
          <div class="card-body px-0 pad-text">
            <div class="d-flex-flex-column gap-0">
              <p class="mb-0 text-start"><?=$user_name.' ('.$user_type.')'?></p>
          ...
          <div class="card border-0 rounded-3">
            ...
            <div class="card-body">
              <div class="d-flex justify-content-between px-2" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                <div class="">
                  <a href="javascript:void(0)" class="text-decoration-none d-flex flex-row gap-2">
              ...
              <?=form_open_multipart(base_url(ADMINPATH.'save-raised-ticket'))?>
              <?=form_hidden('user_role',$user_role)?>
          ...
          <div class="card border-0 rounded-3">
            <div class="card-body px-0">
              <div class="d-flex flex-row justify-content-between px-3">
                <h5 class="mb-0"><?=!empty($rlvalue['user_name'])?$rlvalue['user_name'].' ('.$rlvalue['user_type'].')':''?></h5>
