                        ...
                        if(!empty($triptype)){
                            ...
                            <a href="<?=base_url(ADMINPATH)?>add-<?=strtolower($value['trip_type'])?>-fare">
                                <li class="nav-item">
                                    <button 
                                    type="button"
                                    class="nav-link <?=empty($value) || ($value['trip_type'] =="Outstation")?"active":""?> "
                                    role="tab"
                                    data-bs-toggle="tab"
                                    data-bs-target="#navs-pills-top-oneway"
                                    aria-controls="navs-pills-top-oneway"
                                    aria-selected="<?=empty($value) || ($value['trip_type'] =="Outstation")? true : false ?>">
                    ...
                    <div class="row mb-2">
                        <div class="cstmfld_wrap ">
                              <div class="custom_fields datefld">
                                  ...
                                  <input type="text" name="night_charge_from" placeholder="HH:MM" class="form-control timepicker3" value="<?=$night_charge_from?>">
                              </div>
                              <div class="custom_fields datefld">
  ...
  addBlockBtn.addEventListener('click', function() {
    ...
    const newField = `
      ...
      <div class="custom_fields">
        ...
        <div class="custom_fields">
          <label class="col-form-label">Base Fare</label>
          <input type="text" name="key[${fieldIndex}]basefare" placeholder="Enter fare" class="form-control">
        </div>
        <div class="custom_fields">
          <label class="col-form-label">Rate per KM</label>
          <input type="text" name="key[${fieldIndex}]rateperkm" placeholder="Enter rate" class="form-control">
        </div>
        <div class="custom_fields">
          <label class="col-form-label">Minimum KM</label>
          <input type="text" name="key[${fieldIndex}]minimumkm" placeholder="Enter value" class="form-control">
        </div>
        <div class="custom_fields">
          <label class="col-form-label">Driver Charge(DA)</label>
          <input type="text" name="key[${fieldIndex}]drivercharge" placeholder="Enter value" class="form-control">
        </div>
        <div class="custom_fields">
          <label class="col-form-label">Night Charge</label>
          <input type="text" name="key[${fieldIndex}]nightcharge" placeholder="Enter value" class="form-control">
        </div>
      </div>
    `;
