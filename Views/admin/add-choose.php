        ...
        <div class="card mb-4">
          <div class="card-body">
            <div class="dflexbtwn hdngvwall">
                <h4 class="cardhdng">Add Reason</h4>
                <a href="<?= base_url(ADMINPATH . 'why-choose-us') ?>" class="sitebtn">View Reasons</a>
            </div>   
            <form>
              <input type="hidden" id="choose_id" value="<?=$id?>">
              <div class="row mb-3">
                <div class="col-sm-4">
              ...
              <div class="row justify-content-start">
                ...
                <div class="col-sm-10">
                  <button type="button" onclick="return validateChoose()" id="submit" class="btn btn-primary">Submit</button>
                </div>
                <?php } ?>
              </div>
            </form>
...
<script>
   ...
   if (title=="") {
     ...
     return false;
         ...
         $.ajax({
           url: '<?= base_url(ADMINPATH.'save-choose') ?>',
           type: 'POST',
           data: {
             'id': id,
             'title': title,
