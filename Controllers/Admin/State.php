...
class State extends BaseController {
    ...
    function add_state() {
        ...
        $data['state_code'] = !empty($savedData['state_code']) ? $savedData['state_code'] : '';
    ...
    public function save_state() {
        ...
        $data['state_code'] = (trim($post['state_code']));
    ...
    public function getRecords() {
        ...
        if (!empty($get["search"]["value"])) {
            ...
            $where["state_name LIKE '%" . $searchString . "%' OR state_code LIKE '%" . $searchString . "%' "] = null;
            $limit = 100;
            $start = 0;
        }
