...
class Ratings extends BaseController {
    ...
    public function getRecords() {
        ...
        if (!empty($get["search"]["value"])) {
            ...
            $where["booking_id LIKE '%" . $searchString . "%' OR customer_name LIKE '%" . $searchString . "%'"] = null;
            $limit = 100;
            $start = 0;
        }
